      ...
      for (const resource of group.resources) {
        ...
        rows.push(`
          <tr class="data-row" draggable="true">
            ...
            <td class="editable center-cell" contenteditable="true" data-field="usage">${escapeHtml(group.usage)}</td>
            ...
            <td class="editable" contenteditable="true" data-field="purpose">${escapeHtml(group.purpose)}</td>
            <td class="editable" contenteditable="true" data-field="interaction">${escapeHtml(group.interaction)}</td>

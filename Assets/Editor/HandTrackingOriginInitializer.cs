...
static class HandTrackingOriginInitializer
{
    ...
    {
        foreach (var candidate in Object.FindObjectsByType<XROrigin>(FindObjectsInactive.Include, FindObjectsSortMode.None))
        {
    ...
    {
        foreach (var other in Object.FindObjectsByType<XROrigin>(FindObjectsInactive.Include, FindObjectsSortMode.None))
        {

...
{
    const string LoadingSceneName = "6_LoadingScene";

    static string requestedSceneName;

    [Header("Scene Loading")]
    [SerializeField] string nextSceneName = "3_PPE_Room";
    ...
    /// <summary>
    /// Routes a scene change through 6_LoadingScene. The serialized nextSceneName is
    /// used when 6_LoadingScene is opened directly.
    /// </summary>

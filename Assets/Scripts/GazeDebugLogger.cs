...
public class GazeDebugLogger : MonoBehaviour
{
    ...
    void Start()
    {
        m_Interactor = FindFirstObjectByType<XRGazeInteractor>(FindObjectsInactive.Include);
    ...
    void LogInteractorConfig()
    {
        ...
        var assistance = FindFirstObjectByType<XRGazeAssistance>(FindObjectsInactive.Include);
    ...
    {
        var interactables = FindObjectsByType<XRBaseInteractable>(FindObjectsInactive.Include, FindObjectsSortMode.None);
        var count = 0;
